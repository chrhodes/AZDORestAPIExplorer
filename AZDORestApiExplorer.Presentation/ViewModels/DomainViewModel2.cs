...
namespace AZDORestApiExplorer.Presentation.ViewModels
{
    ...
    public class DomainViewModel2<DType, EType, EArgs, SIEvent, CIEvent> : GridViewModelBase, IInstanceCountVM
        where DType : class, new()
        where EType : PubSubEvent<EArgs>, new()
        where SIEvent : PubSubEvent<DType>, new()
        where CIEvent : PubSubEvent, new()
    {
        #region Constructors, Initialization, and Load

        public DomainViewModel2(
        ...
        private void InitializeViewModel()
        {
            ...
            EventAggregator.GetEvent<CIEvent>().Subscribe(ClearResults);
        ...
        //RESTResult<DType> _results = new RESTResult<DType>();
