...
{
    public class CollectionWrapper : ModelWrapper<Domain.Collection>
    {
        public CollectionWrapper(Domain.Collection model) : base(model)
        {
        }
        ...
        public int? FavoriteCollectionId
        {
            get { return GetValue<int?>(); }
            set { SetValue(value); }
        }
