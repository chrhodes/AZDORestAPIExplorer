...
namespace AZDORestApiExplorer.Presentation.ViewModels
{
    public class CatMainViewModel : EventViewModelBase, ICatMainViewModel, IInstanceCountVM
    {
        ...
        public CatMainViewModel(
            ...
            Func<IFoodDetailViewModel> FoodDetailViewModelCreator,
            ...
            IMessageDialogService messageDialogService) : base(eventAggregator, messageDialogService)
        {
            ...
            _FoodDetailViewModelCreator = FoodDetailViewModelCreator;
        ...
        private Func<IFoodDetailViewModel> _FoodDetailViewModelCreator;
        ...
        public ICatNavigationViewModel NavigationViewModel { get; }
        ...
        private async void OnOpenDetailView(OpenDetailViewEventArgs args)
        {
            ...
            if (detailViewModel == null)
            {
                switch (args.ViewModelName)
                {
                    ...
                    case nameof(FoodDetailViewModel):
                        detailViewModel = _FoodDetailViewModelCreator();
                        break;
