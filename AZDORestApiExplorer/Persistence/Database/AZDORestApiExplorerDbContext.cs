    ...
    public class AZDORestApiExplorerDbContext : DbContext, IAZDORestApiExplorerDbContext
    {
        ...
        public override int SaveChanges()
        {
            ...
            try
            {
                ...
                Log.PERSISTENCE($"(AZDORestApiExplorerDbContext) Exit ({result})", Common.LOG_APPNAME, startTicks);
        ...
        {
            Int64 startTicks = Log.PERSISTENCE("(AZDORestApiExplorerDbContext) Enter", Common.LOG_APPNAME);
