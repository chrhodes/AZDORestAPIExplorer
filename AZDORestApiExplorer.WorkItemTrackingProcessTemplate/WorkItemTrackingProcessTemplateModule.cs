...
namespace AZDORestApiExplorer.WorkItemTrackingProcessTemplate
{
    public class WorkItemTrackingProcessTemplateModule : IModule
    {
        private readonly IRegionManager _regionManager;

        // 01

        public WorkItemTrackingProcessTemplateModule(IRegionManager regionManager)
        {
