...
namespace AZDORestApiExplorer.DomainServices
{
    public class ProjectLookupDataService : IProjectLookupDataService
    {
        ...
        {
            Int64 startTicks = Log.DOMAINSERVICES("(ProjectLookupDataService) Enter", Common.LOG_APPNAME);
            ...
            Log.DOMAINSERVICES("(ProjectLookupDataService) Exit", Common.LOG_APPNAME, startTicks);
