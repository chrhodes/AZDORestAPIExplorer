...
{
    public partial class TemplateMain : ViewBase, IInstanceCountV
    {
        public TemplateMain(
            DomainViewModel<Template, GetTemplatesEvent, GetTemplatesEventArgs, SelectedTemplateChangedEvent> viewModel)
        {
