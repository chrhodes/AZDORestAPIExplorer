...
{
    public partial class WorkItemIconMain : ViewBase, IWorkItemIconMain, IInstanceCountV
    {

        public WorkItemIconMain(ViewModels.IWorkItemIconMainViewModel viewModel)
        {
