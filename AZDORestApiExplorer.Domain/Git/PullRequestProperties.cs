...
namespace AZDORestApiExplorer.Domain.Git
{
    namespace Events
    {
        ...
        public class ClearPullRequestPropertiesEvent : PubSubEvent { }
    ...
    public class PullRequestProperty
    {
        ...
        public async Task<RESTResult<PullRequestProperty>> GetList(GetPullRequestPropertiesEventArgs args)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                //GET https://dev.azure.com/{organization}/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/properties?api-version=6.1-preview.1
