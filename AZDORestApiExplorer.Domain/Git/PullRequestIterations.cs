...
namespace AZDORestApiExplorer.Domain.Git
{
    namespace Events
    {
        ...
        public class ClearPullRequestIterationsEvent : PubSubEvent { }
    ...
    public class PullRequestIteration
    {
        ...
        public async Task<RESTResult<PullRequestIteration>> GetList(GetPullRequestIterationsEventArgs args)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                //GET https://dev.azure.com/{organization}/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/iterations?api-version=6.1-preview.1
                //GET https://dev.azure.com/{organization}/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/iterations?includeCommits={includeCommits}&api-version=6.1-preview.1
                //GET https://dev.azure.com/{organization}/{project}/_apis/git/repositories/{repositoryId}/pullRequests/{pullRequestId}/iterations/{iterationId}?api-version=6.1-preview.1
