...
{
    public partial class PullRequestCommitChangeMain : ViewBase, IInstanceCountV
    {

        public PullRequestCommitChangeMain(DomainViewModel<PullRequestCommitChange, GetPullRequestCommitChangesEvent, GetPullRequestCommitChangesEventArgs, SelectedPullRequestCommitChangeChangedEvent> viewModel)
        {
