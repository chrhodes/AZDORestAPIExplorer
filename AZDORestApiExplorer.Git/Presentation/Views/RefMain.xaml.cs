...
{
    public partial class RefMain : ViewBase, IInstanceCountV
    {
        public RefMain(DomainViewModel<Ref, GetRefsEvent, GetRefsEventArgs, SelectedRefChangedEvent> viewModel)
        {
