...
{
    public partial class PullRequestIterationChangeMain : ViewBase, IInstanceCountV
    {

        public PullRequestIterationChangeMain(DomainViewModel<PullRequestIterationChange, GetPullRequestIterationChangesEvent, GetPullRequestIterationChangesEventArgs, SelectedPullRequestIterationChangeChangedEvent> viewModel)
        {
