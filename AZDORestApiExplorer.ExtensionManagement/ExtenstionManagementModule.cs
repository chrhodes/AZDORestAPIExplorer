...
namespace AZDORestApiExplorer.ExtensionManagement
{
    public class ExtenstionManagementModule : IModule
    {
        private readonly IRegionManager _regionManager;

        // 01

        public ExtenstionManagementModule(IRegionManager regionManager)
        {
