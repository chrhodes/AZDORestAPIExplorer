...
{
    public partial class ControllerMain : ViewBase, IInstanceCountV
    {

        public ControllerMain(DomainViewModel<Controller, GetControllersEvent, GetControllersEventArgs, SelectedControllerChangedEvent> viewModel)
        {
