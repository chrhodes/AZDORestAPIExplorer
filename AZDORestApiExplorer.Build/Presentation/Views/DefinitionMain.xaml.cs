...
{
    public partial class DefinitionMain : ViewBase, IInstanceCountV
    {

        public DefinitionMain(DomainViewModel<Definition, GetDefinitionsEvent, GetDefinitionsEventArgs, SelectedDefinitionChangedEvent> viewModel)
        {
