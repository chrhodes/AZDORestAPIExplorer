...
{
    public partial class BuildChangeMain : ViewBase, IInstanceCountV
    {

        public BuildChangeMain(DomainViewModel<BuildChange, GetBuildChangesEvent, GetBuildChangesEventArgs, SelectedBuildChangeChangedEvent> viewModel)
        {
