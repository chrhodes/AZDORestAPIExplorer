...
{
    public partial class SettingMain : ViewBase, IInstanceCountV
    {

        public SettingMain(DomainViewModel<Setting, GetSettingsEvent, GetSettingsEventArgs, SelectedSettingChangedEvent> viewModel)
        {
