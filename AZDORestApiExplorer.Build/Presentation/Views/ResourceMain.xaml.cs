...
{
    public partial class ResourceMain : ViewBase, IInstanceCountV
    {

        public ResourceMain(DomainViewModel<Resource, GetResourcesEvent, GetResourcesEventArgs, SelectedResourceChangedEvent> viewModel)
        {
