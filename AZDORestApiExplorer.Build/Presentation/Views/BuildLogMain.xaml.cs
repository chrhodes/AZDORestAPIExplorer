...
{
    public partial class BuildLogMain : ViewBase, IInstanceCountV
    {

        public BuildLogMain(DomainViewModel<BuildLog, GetBuildLogsEvent, GetBuildLogsEventArgs, SelectedBuildLogChangedEvent> viewModel)
        {
