...
{
    public partial class BuildWorkItemRefMain : ViewBase, IInstanceCountV
    {

        public BuildWorkItemRefMain(DomainViewModel<BuildWorkItemRef, GetBuildWorkItemRefsEvent, GetBuildWorkItemRefsEventArgs, SelectedBuildWorkItemRefChangedEvent> viewModel)
        {
