...
{
    public partial class OptionMain : ViewBase, IInstanceCountV
    {

        public OptionMain(DomainViewModel<Option, GetOptionsEvent, GetOptionsEventArgs, SelectedOptionChangedEvent> viewModel)
        {
