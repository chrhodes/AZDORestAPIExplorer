...
{
    public class WorkItemTypeWrapper : ModelWrapper<Domain.WorkItemType>
    {
        public WorkItemTypeWrapper(Domain.WorkItemType model) : base(model)
        {
        }
        ...
        public int? FavoriteWorkItemTypeId
        {
            get { return GetValue<int?>(); }
            set { SetValue(value); }
        }
