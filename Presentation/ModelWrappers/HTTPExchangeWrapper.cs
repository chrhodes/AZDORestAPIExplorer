...
{
    public class HTTPExchangeWrapper : ModelWrapper<Domain.HTTPExchange>
    {
        public HTTPExchangeWrapper(Domain.HTTPExchange model) : base(model)
        {
        }
        ...
        public int? FavoriteHTTPExchangeId
        {
            get { return GetValue<int?>(); }
            set { SetValue(value); }
        }
