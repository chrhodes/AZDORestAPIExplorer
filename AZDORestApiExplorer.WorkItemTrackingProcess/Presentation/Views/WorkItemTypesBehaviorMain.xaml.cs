...
{
    public partial class WorkItemTypesBehaviorMain : ViewBase, IInstanceCountV
    {

        public WorkItemTypesBehaviorMain(ViewModels.WorkItemTypesBehaviorMainViewModel viewModel)
        {
