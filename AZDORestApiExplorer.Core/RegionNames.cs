...
namespace AZDORestApiExplorer.Core
{
    public static class RegionNames
    {
        ...
        public static string CommandGetRegion = "CommandGetRegion";
        public static string CommandPatchRegion = "CommandPatchRegion";
        public static string CommandPostRegion = "CommandPostRegion";
        public static string CommandPutRegion = "CommandPutRegion";
        ...
        public static string TeamMainRegion = "TeamMainRegion";
        ...
        public static string BuildInfoMainRegion = "BuildInfoMainRegion";
        public static string BuildChangeMainRegion = "BuildChangeMainRegion";
        public static string BuildLogMainRegion = "BuildLogMainRegion";
        public static string BuildWorkItemRefMainRegion = "BuildWorkItemRefMainRegion";
        ...
        // public static string DashboardDetailRegion = "DashboardDetailRegion";

        public static string WidgetMainRegion = "WidgetMainRegion";
